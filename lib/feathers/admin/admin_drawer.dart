        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const CompanyApprovalScreen()),
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const AdminProductCommonScreen()),
              );
            },
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const AdminWarrantyApprovalScreen()),
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const AdminClaimApprovalScreen()),
              );
            },
          ),
             const Divider(),
